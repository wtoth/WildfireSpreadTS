...
class SMPHeavyTempModel(BaseModel):
    """_summary_ Segmentation model based on the SMP package. We add an HTAE block to the U-Net model.
    """
    def __init__(
        self,
        encoder_name: str,
        ...
        **kwargs: Any
        ...
        print(f"Loaded {encoder_name} with {encoder_weights} weights + HTAE")
