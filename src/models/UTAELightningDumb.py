...
class UTAELightningDumb(BaseModel):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            use_doy=False, # UTAE uses the day of the year as an input feature
            *args,
            **kwargs
        )
        ...
        if encoder_weights == "pastis": 
            pretrained_checkpoint =  '/develop/data/utae_pre/model.pth.tar'
