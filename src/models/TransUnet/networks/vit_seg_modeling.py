...
>>>>>>> 4ea9c5723111b889a1a52ff9ecef1d2f43089db5
...
class Transformer(nn.Module):
    def __init__(self, config, img_size, vis, in_chans):
        ...
        self.embeddings = Embeddings(config, img_size=img_size, in_channels=in_chans)
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False, in_chans=3):
        super(VisionTransformer, self).__init__()
        self.num_classes = num_classes
        self.zero_head = zero_head
        self.classifier = config.classifier
        self.transformer = Transformer(config, img_size, vis, in_chans)
